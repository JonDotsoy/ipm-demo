...
/** @external https://iconmonstr.com/snapchat-1-svg/ */
export const snapchat1Svg: FC<{ className?: string, style?: CSSProperties }> = ({ className, style }) =>
